...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', 'all' for activities with no difficulty set)
    """
    ...
    if difficulty:
        if difficulty.lower() == "all":
            # "Unspecified" filter - shows activities with no difficulty field set
